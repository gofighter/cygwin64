...
"x86_64\-cygwin\-threads\-multi-3\.6\.4\-1\.x86_64" or
	die "Errno architecture (x86_64\-cygwin\-threads\-multi-3\.6\.4\-1\.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
